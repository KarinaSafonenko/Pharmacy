...
<script src="${pageContext.request.contextPath}/js/jquery.themepunch.tools.min.js"></script>
<script src="${pageContext.request.contextPath}/js/jquery.themepunch.revolution.min.js"></script>
<script src="${pageContext.request.contextPath}/js/config-banner-home-4.js"></script>
