...
public class ShowAllProductsPreviousPage extends AbstractShowProducts {
    private static Logger logger = LogManager.getLogger(ShowAllProductsPreviousPage.class);
